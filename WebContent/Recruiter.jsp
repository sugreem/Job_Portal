...
<div class="container-fluid">
  ...
  <div class="row" style="height:80px;">
    ...
    <div class="col-sm-5" style="background-color:#34495e;color:white;padding-top:20px;font-size:20px">
     <a href ="Addjb.jsp" style="color:white;font-size:18px;"><span class="glyphicon glyphicon-plus"></span>Add Job</a>
    &emsp; <a href ="joblist.jsp" style="color:white;font-size:18px;"><span class="glyphicon glyphicon-th-list"></span>Job List</a>
    &emsp; <a href ="appliedjob.jsp" style="color:white;font-size:18px"><span class="glyphicon glyphicon-th-list"></span>Applied Job List</a>
    &emsp; <a href ="profiler.jsp" style="color:white;font-size:18px;"><span class="glyphicon glyphicon-user"></span>My Profile</a>
     
     </div>
    <div class="col-sm-4" style="background-color:#34495e;padding-top:22px;">&emsp;<span style="color:white;font-size:18px;"><b>Hi..<%= loginid %> (Recruiter)&emsp;</b> </span>
