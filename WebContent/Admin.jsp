...
<% 
   ...
   try{loginid = session.getAttribute("loginid").toString();
      }
 catch(Exception e)
...
<div class="container-fluid">
  ...
  <div class="row" style="height:80px;">
    ...
    <div class="col-sm-5" style="background-color:#34495e;color:white;padding-top:20px;font-size:20px">
     <a href ="Adddr.jsp" style="color:white;font-size:18px"><span class="glyphicon glyphicon-plus"></span>Add Recruiter</a>
    &emsp; <a href ="recruiterlist.jsp" style="color:white;font-size:18px"><span class="glyphicon glyphicon-th-list"></span>Recruiter List</a>
    &emsp; <a href ="userlist.jsp" style="color:white;font-size:18px"><span class="glyphicon glyphicon-th-list"></span>User List</a>
    &emsp; <a href ="profilea.jsp" style="color:white;font-size:18px"><span class="glyphicon glyphicon-user"></span>My Profile</a>
     
     </div>
    <div class="col-sm-4" style="background-color:#34495e;padding-top:22px;">&emsp;<span style="color:white;font-size:18px"><b>Hi..<%= loginid%> (Admin)&emsp;</b> </span>
   &emsp; <a href="logout.jsp"style="color:white;font-size:18px"><span class="glyphicon glyphicon-log-out"></span>Logout </a>
...
<h1><i><b> Welcome to Job Portal Management</b></i></h1>
</div>
